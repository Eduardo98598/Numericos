 ...
 * @author Adrian
 */
public class MetodoPuntoFijoMetNumProyectoU2MN extends javax.swing.JFrame {
    ...
    public MetodoPuntoFijoMetNumProyectoU2MN() {
        ...
        metPuntoFijoPojos=new ArrayList<MetPuntoFijo>();
        adaptadorTabla=new ValoresPuntoFijoTableModel(metPuntoFijoPojos);
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Derivada de f(x) evaluada:");

        jLabel5.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/recursosProyectoU2MN/verificado2.png"))); // NOI18N
        jLabel5.setText("(-e^(-x))-1");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!jTextField1.getText().replace(" ","").equals("") && !jTextField2.getText().replace(" ","").equals("")){
            ...
            for(int contador=0;contador<numIteraciones;contador++){
                MetPuntoFijo valorMetNum=new MetPuntoFijo();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MetodoPuntoFijoMetNumProyectoU2MN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MetodoPuntoFijoMetNumProyectoU2MN().setVisible(true);
            }
        });
    }
